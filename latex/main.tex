...
enforces symmetry. Every closed form is validated against independent
...
A fully commented Jupyter notebook reproduces all fourteen figures and both
tables.
\end{abstract}
...
\Phi_U=\Arg\Big[(-1)^\Delta\cos(\pi b)
-i\frac{\Delta(1-C)}{b}\sin(\pi b)\Big]\;}
\label{eq:phiU-of-C}
\end{equation}
